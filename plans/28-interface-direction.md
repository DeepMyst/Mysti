...
| **Agents/setup · Context · Plan & progress · Personas & skills · Context & cost · Connections/MCP · Recovery** | **NOT DONE.** Seven panel redesigns, each roughly the size of a phase on its own. |
