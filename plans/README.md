...
> - **Next (ungated):** Plan 01 (model registry, fixes #39/#32 — extension-side, typechecked) or Plan 00 Batch 2 item 4 (provider session correctness). Plan 03 Phase 4 (streaming render) touches the gated chat webview, so it pairs with the F5 pass.
