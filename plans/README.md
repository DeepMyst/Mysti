...
> - **Next (ungated):** Plan 03 Phase 4 (streaming render path — biggest UX perf win), or Plan 01 (model registry, fixes #39/#32), or Plan 04 (connections), or Plan 00 Batch 2 (process/routing/autonomous-safety structural fixes).
