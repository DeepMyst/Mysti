...
> - **Next (ungated):** Plan 01 Phase 3b (spawn adapters above) or Plan 00 Batch 2 item 4 (provider session correctness B5/B7/B10/B11 + shared spawn harness). Webview-touching work (Plan 03 Phase 4, Plan 01 Phases 4-5, Plan 02 Phases 4-8, Plan 04/05 UI, perf Step 2, canvas F-15 cleanup) pairs with the F5 pass.
>
